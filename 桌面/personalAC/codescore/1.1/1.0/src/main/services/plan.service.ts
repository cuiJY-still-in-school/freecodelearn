...
export function create(
  ...
  try {
    ...
    // Permission check: teacher/admin can manage any student; guardian can manage bound students; student can manage self
    ...
    // Emit event for agent (imported lazily to avoid circular deps)
    try {

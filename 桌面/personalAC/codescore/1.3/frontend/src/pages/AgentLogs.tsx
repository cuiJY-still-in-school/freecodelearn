    ...
    <div>
      ...
      {logs.length > 0 && (
        <div className="grid-4" style={{ marginBottom: 20 }}>
          ...
          <div className="stat-card">
            <div className="stat-label">推送建议</div>
      ...
      >
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <span style={{ fontSize: 13, color: 'var(--text-secondary)' }}>动作类型：</span>
          <select
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <span style={{ fontSize: 13, color: 'var(--text-secondary)' }}>显示条数：</span>
          <select
            className="form-control"
            value={limit}
          ...
          {filteredLogs.map((log, index) => (
            <div
              ...
              style={{
                display: 'flex',
                gap: 16,
                marginBottom: index < filteredLogs.length - 1 ? 10 : 0,
                position: 'relative'
              }}
            >
              {/* Timeline dot */}
              <div style={{ flexShrink: 0, paddingTop: 14 }}>
                <div
                  style={{
                    ...
                    border: `2px solid ${getStatusDotColor(log.status)}`,
                    display: 'flex',
                    alignItems: 'center',
              ...
              <div
                ...
                style={{
                  flex: 1,
                  padding: '12px 16px',
                  borderLeft: `3px solid ${getStatusDotColor(log.status)}`
                }}
              >
                <div
                  style={{
